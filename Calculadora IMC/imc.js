function calcularImc()
{
    ...
    if(imc >=0 && imc < 18.5)
    {
        ...
        document.body.style.background = '#ca9292' 
    }
    else if (imc >= 18.5 && imc <24.9)
    {
        img.src = 'img/peso-ideal.png'
        document.body.style.background = 'rgb(137 137 137)' 
    }
    else if (imc >= 25 && imc <30)
    {
        img.src = 'img/acima do peso.png'
        document.body.style.background = '#f1937e' 
    }
    ...
    else if (imc >= 35.1 && imc <99)
    {
        ...
        document.body.style.background = '#815e4c' 
    }
    else{imc
    }
